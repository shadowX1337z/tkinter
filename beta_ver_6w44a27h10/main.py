...
try:
    ...
    hoi_cai_flask = messagebox.askyesno("Thiếu thư viện","Vui lòng cài thêm thư viện 'Flask' để sử dụng hết chức năng chương trình")
    if hoi_cai_flask == True:
        try:
            import subprocess
            import sys
            subprocess.run(sys.executable,"-m","pip","install","Flask",check = True)
        except subprocess.CalledProcessError as e:
             messagebox.INFO("Install module false","Quá trình tải mô-đun bị lỗ")
...
version = Button(root,text="ver_6w44a27h10",fg="#272727",bg="#00ffd5")
